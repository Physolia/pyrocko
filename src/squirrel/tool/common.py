...
class SquirrelArgumentParser(PyrockoArgumentParser):
    ...
    def set_command(self, command):
        command.setup(self)
        self.set_defaults(target=command.call)
    ...
    def parse_args(self, args=None, namespace=None):
        ...
        eff_parser = args.__dict__.pop('subparser', self)
...
def squirrel_from_selection_arguments(args):
    ...
    Use :py:func:`add_selection_arguments` to configure the parser with the
    necessary options.
...
def add_query_arguments(parser, without=[]):
    '''
...
def squirrel_query_from_arguments(args):
    ...
    Use :py:func:`add_query_arguments` to configure the parser with the
    necessary options.
